...
print("Precision (both) = " + str(prec1))
print("Precision (just Instagram) = " + str(prec2))
print("Precision (neither) = " + str(prec3))
print("Recall (both) = " + str(reca1))
print("Recall (just Instagram) = " + str(reca2))
print("Recall (neither) = " + str(reca3))
